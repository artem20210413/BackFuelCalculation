...
@section('body')
    ...
    <form class="d-flex justify-content-center align-items-center flex-column m-5" method="post">
        @csrf
        ...
        <div class="center mt-2">
            <label class="form-label">Сума заправки</label>
        ...
        <div class="center mt-2">
            ...
            <select required class="form-select @error('fuel_type_alias') is-invalid @enderror" name="fuel_type_alias">
        ...
        <div class="center mt-2">
            ...
            <input required type="range" class="form-range @error('traffic_jam_percentage') is-invalid @enderror"
                   ...
                   value="{{ old('traffic_jam_percentage', 75.3) }}">
        ...
        <div class="center mt-2">
            ...
            <input required type="datetime-local" class="form-control @error('tank_refill_time') is-invalid @enderror"
